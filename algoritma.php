...
function potongAwalanBe($kata)
{
    ...
    if ($_3hurufAwal == "ber") {
        $awalan = $_3hurufAwal;
    } elseif ($_2hurufAwal == "be" && $kata == "bekerja") {
        $awalan = $_2hurufAwal;
    } elseif ($_3hurufAwal == "bel" && $kata == "belajar") {
        $awalan = $_3hurufAwal;
    }
    return $awalan;
    // return $awalan+" "+$kata.substr($awalan.length)+" "+hurufPengganti;
...
function potongAwalanLainnya($kata)
{
    ...
    if ($_3hurufAwal == "ter") {
        $awalan = $_3hurufAwal;
        // $hurufPengganti=['r'];
    } elseif (in_array($_2hurufAwal, $awalanLain)) {
        $awalan = $_2hurufAwal;
    }
    return $awalan;
    // return $awalan+" "+$kata.substr($awalan.length)+" "+hurufPengganti;
    ...
    for ($i = 0; $i < 3; $i++) {
        if ($i == 0) {
            ...
            if (in_array($_3hurufAkhir, $akhiran2)) {
                ...
                $_2hurufAkhir = substr($kata, strlen($kata) - 2);
                $_1hurufAkhir = substr($kata, strlen($kata) - 1);
            } elseif (in_array($_2hurufAkhir, $akhiran2)) {
            ...
            if (in_array($_3hurufAkhir, $akhiran3)) {
                $akhir[$i] = $_3hurufAkhir;
            } elseif (in_array($_2hurufAkhir, $akhiran3)) {
                $akhir[$i] = $_2hurufAkhir;
            } elseif (in_array($_1hurufAkhir, $akhiran3)) {
...
function cariKataDasar($kata)
{
    ...
    $panjang3Akhiran =
        strlen($akhiran[0]) + strlen($akhiran[1]) + strlen($akhiran[2]);
    $kataDasar = substr(
        $kata,
        $panjang2Awalan,
        strlen($kata) - ($panjang3Akhiran + $panjang2Awalan)
    );
    return $kataDasar;
}
function stemmingArifin($kata, $kamus, $stopword)
{
    /* ------------------------------------------------------------------
...
--------------------------------------------------------------------*/
    ...
    if (in_array($kata, $kamus)) {
        if (in_array($kata, $stopword)) {
            return $kata .  " (stopword)";
        }
        return $kata;
    } else {
        /* ------------------------------------------------------------------
...
--------------------------------------------------------------------*/
        $tempKataDasar =
            $awalan[1] . $kataDasar . $akhiran[2] . $akhiran[1] . $akhiran[0];
        if (cekKamus($tempKataDasar, $kamus)) {
            return $tempKataDasar;
        }
        /* -----------------------------------------------------------------
...
--------------------------------------------------------------------*/
        $tempKataDasar =
            $awalan[0] . $awalan[1] . $kataDasar . $akhiran[2] . $akhiran[1];
        if (cekKamus($tempKataDasar, $kamus)) {
            return $tempKataDasar;
        }
        /* -----------------------------------------------------------------
